				...
				<li class="nav-item dropdown ms-lg-3">
					<a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button" data-bs-toggle="dropdown"
						...
						<div class="media d-flex align-items-center">
							<img class="avatar rounded-circle" alt="Image placeholder" src="{{ auth()->user()->getFirstMediaUrl('profiles') ? auth()->user()->getFirstMediaUrl('profiles') : asset('img/team/profile-picture-3.jpg') }}">
