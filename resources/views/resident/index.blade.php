<x-app-layout>
	...
	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
		<div class="d-block mb-md-0">
			<h2 class="h4">Resident Profiling</h2>
		</div>
		<div class="btn-toolbar mb-2 mb-md-0">
			<a href="{{ route('residents.create') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
	...
	<div class="card mb-5">
		<div class="card-body table-wrapper table-responsive">
			<table class="table table-hover" id="resident-table">
				<thead>
					<tr>
						<th>First Name</th>
						<th>Last Name</th>
	...
	{{-- modal --}}
	<x-modal modal-id="resident-modal" button-id="destroy-resident" type="delete" label="resident" />

	@push('scripts')
		<script type="text/javascript" src="{{ asset('js/page/resident/index.js') }}"></script>
	@endpush
