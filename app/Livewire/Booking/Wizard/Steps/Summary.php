...
class Summary extends StepComponent
{
  ...
  public function render()
  {
    ...
    $isletSelectionState = $this->state()->forStep('islet-selection-step');
    $pumpboatSelectionState = $this->state()->forStep('pumpboat-selection-step');
    $passengerProfileState = $this->state()->forStep('passenger-profile-step');
	...
	public function confirm()
	{
		...
		$this->dispatch('close-booking-confirmation-modal');
    $this->dispatch('swal', type:'success', title: 'Booking Success', text: 'The e-ticket has been sent to your email.', url: route('booking.index'));
