...
class PumpboatSelection extends StepComponent
{
  ...
  {
    return view('livewire.booking.wizard.steps.pumpboat-selection', [
  ...
  private function filteredPumpboats()
  {
    ...
    $isletSelectionState = $this->state()->forStep('islet-selection-step'); // returns all state of the given step
